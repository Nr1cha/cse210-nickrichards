...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("below is the getters and setters portion");

        f3.SetTop(1);
        f3.SetBottom(3);
        Console.WriteLine($"3rd constructor, passing 1 and 3: {f3.GetFractionString()}");
        Console.WriteLine($"3rd constructor, passing 1 and 3: {f3.GetDecimalValue()}");
    }
}